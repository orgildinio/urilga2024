    ...
    <div className="relative h-full min-h-screen">
      <div className="absolute top-0 z-0">
        ...
        <Image
          src={logo}
          alt="logo"
          className="absolute xs:bottom-[8%] xxs:bottom-[5%] xl:bottom-[3%] left-1/2 translate-x-[-50%] object-cover z-50 xxs:max-w-[60px] xxs:max-h-[60px] xs:max-w-[100px] xs:max-h-[100px] lg:min-w-[160px] lg:min-h-[160px]"
        />
      </div>
            ...
            <div className="btn-text flex flex-col gap-5 xs:gap-10 justify-center text-center px-3 py-6 md:py-8">
              ...
              <div className="flex justify-center items-center">
                <div className="name xxs:text-[14px] xs:text-[16px] font-adineue font-bold text-center">
                  Будрах цасны мөнгөн ширхэгтэй<br />
                  Болор хундагны жингэнэх чимээтэй<br />
                  Буурал сахалт өвлийн өвгөнтэй<br />
                  Бүжин наадах цасан охидтой<br />
              ...
              <div className="flex flex-col md:flex-row md:gap-10 md:m-auto gap-[10px]">
                ...
                <div className="flex items-center gap-2 text-white font-adineue font-bold text-sm">
                  ...
                  <p>Улаанбаатар зочид буудлын CAMI танхимд</p>
                </div>
              </div>
            </div>
          </div>
